...
latex=Cluster_iteration(Data3,PC,rs,cond) #Check if it is data or data1 or data2 etc.
Data3=latex[[1]]; latex[[2]] #This is the combined epithelia!
...
FeaturePlot(Data3, features = vars,cols = c("#c0c0c0",'red'),pt.size = 1,order=TRUE,min.cutoff=0,ncol=4, split.by=NULL)
