...
library(SeuratWrappers);library(patchwork); #library(popsicleR);
library("proxy");library("spatstat.geom")
...
# This sometimes work, and sometimes not:
...
# Preporsessing Function Before Analysis
...
load("C:/Users/patati/Desktop/TurkuOW/RWork/all_good.RData")
...
fit1 <- segmented(fit0, seg.Z = ~ x,psi = list(x = c(10,50)),control=seg.control(display=FALSE))
# print(summary(fit1)); 
# lines(x, predict(fit1), col = "red"); 
dth=append(dth,ceiling(fit1$psi[,'Est.']))} #
